...
<head>
    ...
    <!--[if lt IE 9]>
    <script src="<?php echo base_url(); ?>front-end/<?php echo base_url(); ?>front-end/js/html5shiv.js"></script>
    <script src="<?php echo base_url(); ?>front-end/<?php echo base_url(); ?>front-end/js/respond.min.js"></script>
    <![endif]-->       
...
<body>
					...
					<tbody>
						<tr>
							<td class="cart_product">
								<a href=""><img src="<?php echo base_url(); ?>front-end/images/cart/one.png" alt=""></a>
							</td>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img src="<?php echo base_url(); ?>front-end/images/cart/two.png" alt=""></a>
							</td>
							<td class="cart_description">
								<h4><a href="">Colorblock Scuba</a></h4>
								<p>Web ID: 1089772</p>
						...
						<tr>
							<td class="cart_product">
								<a href=""><img src="<?php echo base_url(); ?>front-end/images/cart/three.png" alt=""></a>
							</td>
							<td class="cart_description">
								<h4><a href="">Colorblock Scuba</a></h4>
								<p>Web ID: 1089772</p>
    ...
    <script src="<?php echo base_url(); ?>front-end/<?php echo base_url(); ?>front-end/js/jquery.js"></script>
	<script src="<?php echo base_url(); ?>front-end/<?php echo base_url(); ?>front-end/js/bootstrap.min.js"></script>
	<script src="<?php echo base_url(); ?>front-end/<?php echo base_url(); ?>front-end/js/jquery.scrollUp.min.js"></script>
    <script src="<?php echo base_url(); ?>front-end/<?php echo base_url(); ?>front-end/js/jquery.prettyPhoto.js"></script>
    <script src="<?php echo base_url(); ?>front-end/<?php echo base_url(); ?>front-end/js/main.js"></script>
</body>
</html>
